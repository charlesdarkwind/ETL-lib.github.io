...
\item 
def \mbox{\hyperlink{namespace_e_t_l_1_1trusted__tables_ab3bcde4d05ad6b38edf9c5ab230ed8ff}{write}} (config, table, num\+\_\+files=10, df=None, transformation=None, bool incremental=None, $\ast$$\ast$dataframe\+\_\+writer\+\_\+options)
...
\end{DoxyVerb}
 \mbox{\Hypertarget{namespace_e_t_l_1_1trusted__tables_ab3bcde4d05ad6b38edf9c5ab230ed8ff}\label{namespace_e_t_l_1_1trusted__tables_ab3bcde4d05ad6b38edf9c5ab230ed8ff}} 
...
{\footnotesize\ttfamily def E\+T\+L.\+trusted\+\_\+tables.\+write (\begin{DoxyParamCaption}\item[{}]{config,  }\item[{}]{table,  }\item[{}]{num\+\_\+files = {\ttfamily 10},  }\item[{}]{df = {\ttfamily None},  }\item[{}]{transformation = {\ttfamily None},  }\item[{bool }]{incremental = {\ttfamily None},  }\item[{$\ast$$\ast$}]{dataframe\+\_\+writer\+\_\+options }\end{DoxyParamCaption})}
